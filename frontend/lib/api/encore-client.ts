// Code generated by the Encore v1.46.5 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
  return `https://${name}-lead-explorer-6dc2.encr.app`;
}
...
/**
 * Client is an API client for the lead-explorer-6dc2 Encore application.
 */
...
export namespace subscription {
  ...
  export class ServiceClient {
     ...
     */
    public async stripeWebhookHandler(
      method: "POST",
      body?: BodyInit,
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "lead-explorer-6dc2-Generated-TS-Client (Encore/v1.46.5)";
    }
